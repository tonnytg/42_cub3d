...
/*   Updated: 2024/03/27 00:02:24 by antthoma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
1 -> Pixel por Pixel -> mlx_pixel_put();
2 -> Address da Imagem -> mlx_get_data_addr();
3 -> Tem que ter a Imagem -> mlx_xpm_file_to_image();
4 -> Tem que ter carregado a imagem -> ft_strdup()
