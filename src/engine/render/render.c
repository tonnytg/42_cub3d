...
/*   Updated: 2023/10/27 21:09:52 by lbiasuz          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	render_game(t_game *game)
{
	...
	int end_x = game->player->x + 6 * cos(game->player->angle * (M_PI / 180.0));
	int end_y = game->player->y + 6 * sin(game->player->angle * (M_PI / 180.0));
